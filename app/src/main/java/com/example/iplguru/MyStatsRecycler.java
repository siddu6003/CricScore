...
public class MyStatsRecycler extends RecyclerView.Adapter<MyStatsRecycler.MyViewHolder> {
    int[] img;
    String stats[][];
    Context context;
    String players[];
    public MyStatsRecycler(Context c, int[] images,String[] names,String[][] details){
        context=c;
        img=images;
        players=names;
        stats=details;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyStatsRecycler.MyViewHolder(view);
    }
